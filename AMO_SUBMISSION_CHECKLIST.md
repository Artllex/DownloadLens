...
## Files
- `dist/DownloadLens-1.3.2.xpi` — upload as the extension.
- `dist/DownloadLens-1.3.2-review-source.zip` — source and companion implementation for review.
